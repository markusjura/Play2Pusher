...
To use this module on your Play 2.1 application, you need to modify your @Build.scala@ file:

<pre>
val appDependencies = Seq(
  (... your other dependencies, if any ...)
  "tindr" %% "play2pusher" % "1.1" // Tindr's play2pusher module dependency
)

val main = PlayProject(appName, appVersion, appDependencies, mainLang = SCALA).settings( 
  (... your other settings, if any ...)
  resolvers += Resolver.url("Markus Jura github repo play2pusher", url("http://markusjura.github.com/Play2Pusher"))(Resolver.ivyStylePatterns)
)
</pre>
